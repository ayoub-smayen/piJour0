...
import com.project0.esprit.util.generators.*;
//ameni.souelmia@esprit.tn
...
public class BarcodesController {
    ...
    public ResponseEntity<BufferedImage> barbecueUPCABarcode(@PathVariable(name="barcode") String barcode) throws Exception {
        return okResponse(BarbecueBarcodeGenerator.generateUPCABarcodeImage(barcode));
    }

    @GetMapping(value = "/barbecue/ean13/{barcode}", produces = MediaType.IMAGE_PNG_VALUE)
    public ResponseEntity<BufferedImage> barbecueEAN13Barcode(@PathVariable(name="barcode") String barcode) throws Exception {
    ...
    public ResponseEntity<BufferedImage> barcode4jUPCABarcode(@PathVariable(name="barcode") String barcode) {
    ...
    public ResponseEntity<BufferedImage> barcode4jEAN13Barcode(@PathVariable(name="barcode") String barcode) {
    ...
    public ResponseEntity<BufferedImage> zxingUPCABarcode(@PathVariable(name="barcode") String barcode) throws Exception {
    ...
    public ResponseEntity<BufferedImage> zxingEAN13Barcode(@PathVariable(name="barcode") String barcode) throws Exception {
